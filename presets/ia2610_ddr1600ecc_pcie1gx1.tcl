proc getPresetInfo {} {
  return [dict create name {iaia2610_ddr1600ecc_pcie1gx1} description {iaia2610_ddr1600ecc_pcie1gx1}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.3 display_name {iaia2610_ddr1600ecc_pcie1gx1} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash########SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#############UART 1#UART 1###PCIE######SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#I2C 1#I2C 1###########Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3}  \
    ...
    CONFIG.PSU__CRL_APB__PL3_REF_CTRL__DIVISOR0 {40}  \
    ...
    CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {199.999985}  \
    CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {124.999992}  \
    CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {99.999992}  \
    CONFIG.PSU__CRL_APB__PL3_REF_CTRL__ACT_FREQMHZ {24.999998}  \
