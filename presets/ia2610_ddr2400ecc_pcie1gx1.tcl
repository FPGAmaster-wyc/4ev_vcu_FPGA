proc getPresetInfo {} {
  return [dict create name {ia2610_ddr2400ecc_pcie1gx1} description {ia2610_ddr2400ecc_pcie1gx1}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.3 display_name {ia2610_ddr2400ecc_pcie1gx1} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PSU__CRL_APB__PL3_REF_CTRL__ACT_FREQMHZ {24.999750}  \
